...
impl Ranker<'_> {
    ...
    fn get_results_hashmap(&self, input: &str, result_count: usize) -> Result<HashMap<PathBuf, (PathType, f32)>> {
    ...
    pub fn get_results(&self, input: &str, result_count: usize) -> Result<Vec<RankResult>> {
